//create UI object that will contain all the nav on the page
var ui = {};

// load the object up as html with the backtick
ui.navigation = `
    <nav class="navbar navbar-expand-lg bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" onclick="loadAllData()" id="allData">All Data</a>
                </li>
            </ul>
        </div>
    </nav>
...
// then take the HTML we just put in the object, pull the ID from the index file and then inject the above HTML in
var navigation = document.getElementById('navigation');
navigation.innerHTML += ui.navigation;

//now we're finna write some more modules bruh
...
//funcitons that grabs the target id in the index and loads our HTML we wrote in the object above
